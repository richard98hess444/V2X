...
PlatoonMsg::PlatoonMsg(const char *name, short kind) : ::veins::BaseFrame1609_4(name,kind)
{
    this->timeStampP = 0;
    this->senderAddress = -1;
}

PlatoonMsg::PlatoonMsg(const PlatoonMsg& other) : ::veins::BaseFrame1609_4(other)
{
    copy(other);
}
...
Coord& PlatoonMsg::getSenderPos()
{
    return this->senderPos;
}

void PlatoonMsg::setSenderPos(const Coord& senderPos)
{
    this->senderPos = senderPos;
}

Coord& PlatoonMsg::getSenderVel()
{
    return this->senderVel;
}

void PlatoonMsg::setSenderVel(const Coord& senderVel)
{
    this->senderVel = senderVel;
}

::omnetpp::simtime_t PlatoonMsg::getTimeStampP() const
{
    return this->timeStampP;
}

void PlatoonMsg::setTimeStampP(::omnetpp::simtime_t timeStampP)
{
    this->timeStampP = timeStampP;
}

LAddress::L2Type& PlatoonMsg::getSenderAddress()
{
    return this->senderAddress;
}

void PlatoonMsg::setSenderAddress(const LAddress::L2Type& senderAddress)
{
...
PlatoonMsgDescriptor::PlatoonMsgDescriptor() : omnetpp::cClassDescriptor("veins::PlatoonMsg", "veins::BaseFrame1609_4")
{
